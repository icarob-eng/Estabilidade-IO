...
Todos os nós são armazenados numa classe `Structure`, que representa um projeto como um todo e 
é usada como base para calcular os parâmetros físicos.
